...
export default defineConfig({
  ...
  redirects: {
    '/marketplace/plugins/i/datocms-plugin-yoast-seo': '/marketplace/plugins/i/datocms-plugin-seo-readability-analysis',
    ...
    '/plugins/i/@stackbitdatocms-plugin-typed-list': '/marketplace/plugins/i/@stackbit/datocms-plugin-typed-list',
    '/plugins/i/@ecologicdatocms-plugin-multiselect': '/marketplace/plugins/i/@ecologic/datocms-plugin-multiselect',
    '/plugins/i/@ecologicdatocms-plugin-ordered-tag-editor': '/marketplace/plugins/i/@ecologic/datocms-plugin-ordered-tag-editor',
    ...
    '/blog/offer-responsive-progressive-lqip-images-in-2020': '/blog/best-way-for-handling-react-images',
    ...
    '/docs/pro-tips/manage-draft-published-state-by-locale': '/docs/general-concepts/localization#locale-based-publishing',
    '/marketplace/starters/next-js-multilingual-blog-per-local-publishing': '/docs/general-concepts/localization#locale-based-publishing',
    ...
    '/blog/introducing-visual-editing-for-vercel-and-datocms-enterprise-customers': '/blog/introducing-content-link-for-vercel-and-datocms-enterprise-customers',
    '/blog/july-update-visual-editing-and-per-locale-publishing': '/blog/july-update-content-link-and-per-locale-publishing',
    ...
    '/docs/project-starters-and-templates/clone-project-button': '/docs/general-concepts/project-starters-and-templates#generate-a-clone-project-button',
    '/docs/project-starters-and-templates/project-starter-button': '/docs/general-concepts/project-starters-and-templates#generate-a-project-starter-button',
    ...
    '/docs/content-management-api/resources/sso-token': '/docs/content-management-api/resources/sso-settings/generate_token',
    '/docs/next-js/setting-up-next-js-preview-mode': '/docs/legacy-next-js-documentation/setting-up-next-js-preview-mode',
    ...
    '/cms/hugo-cms': '/',
    '/marketplace/starters/next-13-company-landing-page-demo': '/marketplace/starters/next-js-starter-kit',
    '/docs/agency-partner-program/benefits': '/partner-program',
    '/docs/site-search/excluding-text': '/docs/site-search/how-the-crawling-works#excluding-content-from-indexing',
    // --- 12.12.24 ---
    ...
    '/docs/gatsby': '/docs',
    '/docs/plugin-sdk': '/docs/plugin-sdk/introduction',
    '/blog/offer-responsive-progressive-lqip-images-in-2020': '/blog',
    '/docs/plugins/install': '/docs/plugin-sdk/introduction',
    '/docs/other-ssgs': '/docs',
    '/docs/guides/building-plugins/sdk-reference': '/docs/plugin-sdk/build-your-first-plugin',
    '/docs/plugins/entry-point': '/docs/plugin-sdk/build-your-first-plugin',
    '/docs/content-delivery-api/seo': '/docs/content-delivery-api/seo-and-favicon',
    '/docs/general-concepts/images': '/docs/general-concepts/media-area',
    '/docs/visual-editing/how-to-use-visual-editing': '/docs/content-link/how-to-use-content-link',
    '/docs/introduction/custom-assets-domain': '/docs/asset-api/asset-cdn-settings',
    '/docs/plugins/publishing': '/docs/plugin-sdk/publishing-to-marketplace',
    '/docs/content-delivery-api/filtering': '/docs/content-delivery-api/filtering-records',
    '/blog/static-ecommerce-website-snipcart-gatsbyjs-datocms': '/blog',
    '/docs/react': '/docs',
    ...
    '/docs/content-delivery-api/querying': '/docs/content-delivery-api/how-to-fetch-records',
    '/marketplace/hosting/zeit': '/marketplace/plugins',
    '/docs/next-js/setting-up-next-js-preview-mode': '/docs/legacy-next-js-documentation/setting-up-next-js-preview-mode',
    '/docs/general-concepts/videos': '/docs/general-concepts/media-area',
    '/docs/content-delivery-api/docs/general-concepts/roles-and-permission-system': '/docs/general-concepts/roles-and-permission-system',
    '/docs/plugin-sdk/execute-code-on-boot': '/docs/plugin-sdk/introduction',
    '/cms/react': '/cms/react-cms',
    '/docs/guides/single-sign-on/configure-sso-with-okta': '/docs/content-management-api/resources/sso-settings',
    '/blog/introducing-visual-editing-for-vercel-and-datocms-enterprise-customers': '/blog/introducing-content-link-for-vercel-and-datocms-enterprise-customers',
    '/docs/vue/display-videos': '/docs/nuxt/displaying-videos',
    '/docs/guides/single-sign-on/configure-sso-with-onelogin': '/docs/content-management-api/resources/sso-settings',
    '/docs/general-concepts/environments': '/docs/general-concepts/primary-and-sandbox-environments',
    '/docs/content-management-api/using-the-ruby-client': '/product-updates/ruby-client-deprecation-for-v-less-than-0-7-3',
    '/docs/plugin-sdk/upload%E2%80%8BSidebar%E2%80%8BPanels': '/docs/plugin-sdk/sidebar-panels',
    '/docs/vue/loading-responsive-progressive-images-from-datocms': '/docs/nuxt/managing-images',
    '/docs/vue': '/docs/nuxt/',
    '/docs/cdn-settings/advanced-asset-settings': '/docs/asset-api/asset-cdn-settings',
    '/docs/plugin-sdk/render%E2%80%8BUpload%E2%80%8BSidebarPanel': '/docs/plugin-sdk/sidebar-panels',
    '/docs/general-concepts/pricing': '/pricing',
    '/docs/plugin-sdk/sdk/field-extensions': '/docs/plugin-sdk/field-extensions',
    '/docs/building-plugins/install': '/docs/plugin-sdk/build-your-first-plugin#install-your-plugin-in-the-datocms-web-app',
    '/docs/building-plugins/publishing': '/docs/plugin-sdk/publishing-to-marketplace',
    '/docs/security': '/docs',
    '/docs/project-starters-and-templates': '/marketplace/starters',
    '/docs/content-management-api/resources/sso-token': '/docs/content-management-api/resources/sso-settings',
    '/docs/guides': '/docs',
    '/docs/sveltekit/getting-started-with-sveltekit-and-datocms': '/docs/svelte',
    '/docs/react/managing-images': '/docs',
    '/marketplace/plugins/i/git@github.com:voorhoede/datocms-plugin-editor-help.git': '/marketplace/plugins',
    '/docs/content-management-api/rate-limits': '/docs/content-management-api/technical-limits',
    '/partners/dev-kitchen': '/partners',
    '/docs/content-delivery-api/uploads': '/docs/content-delivery-api/images-and-videos',
    ...
    '/docs/agency-partner-program/benefits': '/partner-program',
    '/docs/content-delivery-api/rate-limiting': '/docs/content-management-api/technical-limits',
    ...
    '/blog/introducing-inherited-roles-for-greater-modularity-in-role-management': '/blog/introducing-inherited-roles',
    '/cms/hugo-cms': '/',
    ...
    '/docs/content-management-api/resources/item/instances/docs/content-management-api/resources/item/instances': '/docs/content-management-api',
    ...
    '/partners/harvey-cameron': '/partners',
    '/docs/content-modelling/data-migration/docs/content-modelling/data-migration': '/docs/content-modelling/data-migration',
    '/marketplace/starters/nextjs-blog': '/marketplace/starters/next-js-starter-kit',
    '/docs/pro-tips/manage-draft-published-state-by-locale': '/docs',
    '/partners/harvey-cameron/showcase/jacuzzi': '/partners',
    ...
    '/docs/guides/custom-assets-domain/google-cloud-storage': '/marketplace/enterprise/google-cloud-storage',
    ...
    '/cms/nextjs': '/cms/nextjs-cms',
    '/docs/content-management-api/resources/upload/updatebut': '/docs/content-management-api/resources/upload',
  },
});
