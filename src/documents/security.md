...
Our web servers are running in a dedicated Kubernetes cluster in AWS. No other applications are running in the same cluster, which is managed by DatoCMS and hosted on AWS EKS service.
