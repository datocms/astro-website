...
export default function FieldValidations() {
  ...
  useEffect(() => {
    const interval = setInterval(() => setCount((count) => (count + 1) % 5), 1000);
      ...
      <div className={s.body}>
        ...
        <div className={s.validations}>
          ...
          <div className={s.validation}>
            ...
            <div className={s.validationBody}>
              <div className={s.validationLabel}>Accept only specified file size</div>
              <div className={s.validationHint}>
          ...
          <div className={s.validation}>
            ...
            <div className={s.validationBody}>
              <div className={s.validationLabel}>Accept only specified extensions</div>
              <div className={s.validationHint}>
                You won&#39;t be able to save or publish a record if the file doesn&#39;t end with
                one the specified values
              </div>
          ...
          <div className={s.validation}>
            ...
            <div className={s.validationBody}>
              <div className={s.validationLabel}>Accept only specified image dimensions</div>
              <div className={s.validationHint}>
          ...
          <div className={s.validation}>
            ...
            <div className={s.validationBody}>
              ...
              <div className={s.validationHint}>Specify which image metadata has to be present</div>
            </div>
          </div>
        </div>
