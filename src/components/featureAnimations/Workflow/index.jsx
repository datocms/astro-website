...
const steps = ['draft', 'review', 'changes', 'draft', 'review', 'approved', 'published'];

const labels = ['📝 Draft', '🕵️ In review', '🚨 Changes requested', '👌 Approved', '🎉 Published'];
            ...
            >
              <div className={s.person}>
                <div className={s.personIcon}>
                  <img loading="lazy" src={`/images/faces/${transitions[transition].image}`} />
                </div>
                <div>
                  <div className={s.personName}>{transitions[transition].name}</div>
                  <div className={s.personRole}>{transitions[transition].role}</div>
                </div>
              </div>
            </CSSTransition>
          )}
