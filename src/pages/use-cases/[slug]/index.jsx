...
function FeatureCard({ feature }) {
  return (
    <div key={feature.id} className={`${s.feature} ${feature.highlight && s.isHighlighted}`}>
    ...
    <Layout preview={preview} finalCta={false}>
      ...
      <Wrapper>
        <div className={s.hero}>
          <div className={s.heroBody}>
            ...
            <div className={s.heroSubtitle}>{highlightStructuredText(page.subtitle)}</div>
          ...
          <div className={s.heroImageWrapper}>
            {page.heroCustomer?.responsiveImage && page.heroProduct?.responsiveImage ? (
              <>
              ...
              page.heroImage?.responsiveImage && <DatoImage data={page.heroImage.responsiveImage} />
            )}
          </div>
        </div>
      </Wrapper>
      ...
      <div className={s.features}>
        ...
        {page.callout.map((callout, index) => (
          <section key={index} className={cn(s.featuresGroup, { [s.alternative]: index === 1 })}>
        ...
        <Wrapper>
          <div className={s.successStory}>
            <div className={s.successStoryText}>
              ...
              <Space top={1}>
                <Button as="a" p="small" s="purple" href={`/customers/${page.caseStudy.slug}`}>
                  Check it out
                </Button>
              </Space>
            </div>
